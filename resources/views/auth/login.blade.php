        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mt-4">
                        <div class="mb-3">
                            <a href="index.html" class="auth-logo">
                                <img src="{{ asset('backend/assets/images/tour1.jpg') }}" height="70"
                    ...
                    <h4 class="text-muted text-center font-size-18"><b>Tours & Travels
                         Agency</b></h4>

                    <h4 class="text-muted text-center font-size-18">Log In</h4>
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input id="username" name="username" value="{{ old('username') }}"
                                        class="form-control" type="text" required="" placeholder="Username">
